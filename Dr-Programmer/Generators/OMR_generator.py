...
This is a segment of the 'OMR Scanner' project given to certain Computer Science(CS) for IDK whatever reasons.
;)


basically used Pillow(PIL) library to generate an A4 PDF. (Later versions will support more paper like A3, letter size etc)
- Making a blank white sheet.
- Drew Borders.
- Drew registration markers.
- Drew QR for machine readability
- Made header for human readability
- Wrote questions.
- Gave option to save as *.png or *.pdf.

Now fk off and read the code to know what I did man.


When I wrote this, Only I and God knew how it works. Now only God knows. ;)
"""
